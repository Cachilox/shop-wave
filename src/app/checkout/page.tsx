...
const Checkout = () => {
  ...
  const handleSelectedAddress = async (getAddress: any) => {
  ...
  if (orderSuccess) {
    return (
      <section className="h-screen bg-gray-200">
        <div className="mx-auto mt-32 px-4 sm:px-6 lg:px-8">
    ...
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-24">
          <p className="font-medium text-xl mt-4">Cart Summary</p>
        ...
        <div className="mt-24 bg-gray-50 pt-4 px-4">
